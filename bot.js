...
// Фиктивный HTTP-сервер для health check
...
const surprises = [
  ...
  '🍷 Давай устроим виртуальный вечер? Зажги свечу и представь меня рядом. 🕯️',
...
['SIGINT', 'SIGTERM'].forEach((signal) => {
  process.on(signal, () => {
    ...
    try {
      ...
      server.close(() => console.log('HTTP-сервер остановлен')); // Закрываем HTTP-сервер
